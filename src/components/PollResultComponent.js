...
import {styles} from '../misc/StyleHelper';
...
export class PollResultComponent extends Component {
    static propTypes = {
...
export default withRouter(connect(mapStateToProps)(PollResultComponent));
